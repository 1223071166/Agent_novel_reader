...
class ChatService:
    def __init__(self) -> None:
        ...
        self._initial_messages = [
            {"role": "system", "content": get_system_prompt(USE_SUMMARY_TOOL)},
            {"role": "system", "content": "这是小说的基本信息：" + info_text},
        ]
        load_titles()
    ...
    def get_messages(self, conversation_id: str) -> list[dict[str, Any]]:
        ...
        with self._conversations_lock:
            return copy.deepcopy(self._conversations[conversation_id])
    ...
    def _append_tool_result(self, conversation_id: str, call_id: str, result: Any) -> None:
        self._append_message(conversation_id, {
            "role": "tool",
            "tool_call_id": call_id,
            "content": json.dumps(result, ensure_ascii=False, default=str),
        })

    def _append_message(self, conversation_id: str, message: dict[str, Any]) -> None:
        with self._conversations_lock:
    ...
    def _copy_initial_messages(self) -> list[dict[str, Any]]:
